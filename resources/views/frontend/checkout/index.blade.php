<x-frontend-layout title="About page">
    <x-frontend.breadcrumb title="Checkout" subtitle="Checkout" link="/checkout" linkText="Checkout" />
                ...
                <div class="col-lg-8 col-lg-7 wow fadeInUp" data-wow-duration="1s">
                    <div class="fp__checkout_form">
                        <div class="fp__check_form">
                            <h5>select address <a href="#" data-bs-toggle="modal"
                                    data-bs-target="#address_modal"><i class="far fa-plus"></i> add address</a></h5>
